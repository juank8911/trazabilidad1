...
kendo.ui.Locale = "Español de ESPAÑA (es-ES)";
...
var labels = {
	...
	"Groupable": {
		"messages": { 
			"empty": "Arrastre el título de una columna y suéltelo aquí para agruparlas"
		}
	},
        "create": {
		"messages": { 
			"Add new record": "Crear Nuevo"
		}
	},
        "Toolbar": {
		"messages": { 
			"Export to Excel": "Exportar"
		}
	},
	"FilterMenu": {
		"messages": {
	...
	"Validator": {
		"messages": {
			...
			"step": "{0} no es válido",
			"email": "{0} no es correcta",
			"url": "{0} no es un URL válido",
			"date": "{0} no es correcta"
		}
	},
	"ImageBrowser": {
		"messages": {
	...
	"Editor": {
		"messages": {
			...
			"insertOrderedList": "Insertar una lista numerada",
...
for(var componentName in labels){
	var component = labels[componentName];
